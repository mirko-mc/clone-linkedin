...
function MyNav() {
    const { selectedUser, token, setToken, setUserInfo } = useContext(UserContext);
  ...
  const handleRegister = async () => {
    ...
    if (res) {
        ...
        alert('Errore durante la registrazione: ' + (res.error || 'Errore sconosciuto'));
    }
};
        ...
        <Navbar className="bg-body">
            <Container>
                <Navbar.Brand href="#home">
                    <svg className="logo" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                    ...
                    <Nav className="me-auto">
                        ...
                        <div className="d-flex flex-column align-items-center">
                            <NavDropdown title={<img src={selectedUser?.avatar} alt="" className="rounded-circle1" />} id="collapsible-nav-dropdown">
                                ...
                                <NavDropdown.Divider />
                                <NavDropdown.Item>
                                    <span className="dropDownLink click" onClick={handleLogout}>Esci</span>
                                </NavDropdown.Item>
                            </NavDropdown>
                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            <Form.Group className="mb-3" controlId="exampleForm.ControlInput7">
                                ...
                                <Form.Control type="file" name="avatar" onChange={handleChangeImage} />
                            </Form.Group>
                        </Form>
                    </Modal.Body>
                    <Modal.Footer>
